...
def send_mail(kiosk_dto: KioskDTO) -> None:
    """Funktion, um eine E-Mail zu senden.

    :param kiosk_dto: Kiosk-Daten
    """
    ...
    # Body und Subject
    msg: Final = MIMEText(f"Neuer Kiosk: <b>{kiosk_dto.name}</b>")
    msg["Subject"] = f"Neuer Kiosk: ID={kiosk_dto.id}"
