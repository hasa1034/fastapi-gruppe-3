...
# Aufruf:   docker build --tag juergenzimmermann/kiosk:2026.4.1-hardened .
#               ggf. --no-cache
#
...
#
#           docker debug juergenzimmermann/kiosk:2026.4.1-hardened
#           docker scout sbom juergenzimmermann/kiosk:2026.4.1-hardened
#           docker scout cves juergenzimmermann/kiosk:2026.4.1-hardened
#           docker save juergenzimmermann/kiosk:2026.4.1-hardened > kiosk.tar
...
LABEL org.opencontainers.image.title="kiosk" \
    org.opencontainers.image.description="Appserver kiosk mit Basis-Image Trixie hardened" \
